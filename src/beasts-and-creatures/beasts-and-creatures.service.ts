...
export class BeastsAndCreaturesService {
  constructor(
    @InjectModel('BeastsAndCreatures') private readonly BeastsAndCreaturesModule: Model<BeastsAndCreatures>,
  ) {}

  async create(beastsAndCreaturesDto: BeastsAndCreaturesDto): Promise<BeastsAndCreatures> {
  ...
  async findAll(): Promise<BeastsAndCreatures[]> {
  ...
  async update(id: string, beastsAndCreaturesDto: BeastsAndCreaturesDto): Promise<BeastsAndCreatures> {
